 ...
 */
@WebServlet(urlPatterns = {"/listado_nombre"})
public class listado_nombre extends HttpServlet {
Controlador controlador = new Controlador();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            List <Persona> resp = controlador.Listado(request.getParameter("listaNombre"));
            out.println("<!DOCTYPE html>");
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet listado_nombre</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Listado filtrado por nombre:</h1>");
